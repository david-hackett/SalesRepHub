            ...
            function createMarker(index) {
                if (index < locations.length) {
                    ...
                    marker.addListener('click', function () {
                        ...
                        app.navigate("views/singleCardView.html?cardName=" + tmpLocation["Name"] + "&cardTel=" + tmpLocation["Phone"] + "&cardCity=" + tmpLocation["City"] + "&cardState=" + tmpLocation["State"] + "&cardZip=" + tmpLocation["Zip"] + "&cardCurr=" + tmpLocation["Currency"] + "&cardSite=" + tmpLocation["Site"] + "&cardContact=" + tmpLocation["Contact"]);
